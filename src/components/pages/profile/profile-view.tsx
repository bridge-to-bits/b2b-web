  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <div className="relative max-w-[1280px] mx-auto px-20 pb-20">
        ...
        <div className="relative w-32 h-32 md:w-44 md:h-44 border-4 border-black -translate-y-1/2">
          <Image
            src={avatar ?? ''}
            alt="Avatar"
            fill
          ...
          {isMe && (
            <Button type="button" className="mt-4 absolute left-[600%] top-20" onClick={toggleEditing}>
              Редагувати профіль
            </Button>
          )}
        </div>
        ...
        <div className="mt-[-60px]">
          ...
          <p className="mt-2">
            Жанр: {genres.length ? genres.map((genre) => genre.name).join(', ') : 'Не вказані'}
          </p>
