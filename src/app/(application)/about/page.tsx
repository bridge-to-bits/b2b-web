    ...
    <div className="w-full min-h-screen max-w-[1920px] mx-auto overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row items-center mt-16 justify-center">
        <div className="relative w-full sm:w-[810px] h-[300px] sm:h-[492px]">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[80%] text-white text-[24px] sm:text-[48px] lg:text-[66px] font-rubik italic">
            Про нас
          </div>
        </div>
        <div className="w-full sm:w-[971px] h-auto text-[16px] sm:text-[18px] lg:text-[36px] font-rubik mt-4 sm:mt-0 sm:ml-5 px-4 sm:px-0 ">
          <p>
...
{/* Vision Section flex flex-col  mt-6 px-4 sm:px-0 ml-10*/}
<div className="flex flex-col items-center mt-12 mb-16 px-4 ml-10">
<div className="w-full sm:w-[1552px] text-[24px] sm:text-[48px] lg:text-[66px] font-rubik italic mt-14 mr-5 text-right ">
  Наша місія
</div>
<div className="w-full sm:w-[1638px] text-[16px] sm:text-[18px] lg:text-[36px] font-rubik mt-5 ml-10 md:ml-0 lg:ml-5 sm:ml-5 text-center ">
  Об’єднувати музикантів і продюсерів, надихаючи на співпрацю, що руйнує кордони й створює звук майбутнього.
</div>
  <div className="w-full sm:w-[1552px] sm:p4 text-[24px] sm:text-[48px] lg:text-[66px] font-rubik italic ml-0 mt-10 sm:ml-5 text-left">
    Наша візія
  </div>
  <div className="w-full sm:w-[1638px] text-[16px] sm:text-[18px] lg:text-[36px] font-rubik mt-5 ml-10 sm:ml-5 text-center ">
